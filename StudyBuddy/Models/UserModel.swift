...
func createTestUser(_ email: String, _ userName: String, _ date1: Date, _ date2: Date, _ date3: Date, _ flashcardText1: String, _ flashcardText2: String, _ flashcardText3: String) -> UserModel {
    ...
    user.studySets = [
        ...
        StudySetModel(flashcards: [flashcard2], dateCreated: date2, createdBy: user.userName, name: "",documentIDs: []),
        StudySetModel(flashcards: [flashcard3], dateCreated: date3, createdBy: user.userName, name: "",documentIDs: []),
    ]
